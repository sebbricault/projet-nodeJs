  ...
  return sequelize.define(
    "Pokemon",
    {
      ...
      cp: {
        ...
        validate: {
          isInt: {
            msg: "Utiliser uniquement des nombres entiers pour les points de dégâts.",
          },
          min: {
            args: [0],
            msg: "Les points de vie doivent être supérieurs ou égales à 0",
      ...
      picture: {
        ...
        validate: {
          isUrl: {
            msg: "Utiliser uniquement une URL valide pour l'image.",
          },
        ...
        validate: {
          isTypesValid(value) {
            ...
            if (value.split(",").length > 3) {
              throw new Error("Un pokémon ne peux avoir plus de trois type.");
            }
